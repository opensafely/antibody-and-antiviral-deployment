...
The code and data for this report can be found in the OpenSAFELY [antibody-and-antiviral-deployment repository](https://github.com/opensafely/antibody-and-antiviral-deployment). The accompanying manuscript is available on [MedRXiV](https://www.medrxiv.org/content/10.1101/2022.03.07.22272026v2) and is currently undergoing review at a peer-reviewed journal.

*Update: As of 1st July 2022, our coverage report will be published monthly. If you rely on more regular updates for your own reporting or analysis please contact team@opensafely.org to let us know.*
