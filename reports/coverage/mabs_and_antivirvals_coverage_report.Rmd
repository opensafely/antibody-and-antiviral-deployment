...
table_elig_treat_redacted %>%
  ...
  add_header_above(., c(" ", "Eligible", "All" = 2, "Paxlovid  " = 1, "Sotrovimab" = 1, "Remedesivir" = 1,
...
table_demo_clinc_breakdown_redacted <- read_csv(fs::path(input_dir_os, "table_demo_clinc_breakdown_redacted.csv")) %>%
  mutate(Group = factor(Group, 
         ...
         Variable = factor(Variable, levels = c("12-29", "30-39", "40-49", "50-59", "60-69", "70-79", "80+", 
                                                "Female", "Male" ,
  ...
  mutate(Treated_perc = round(Treated/All*100, digits = 0),
         ...
         Remedesivir = paste(Remedesivir, " (", round(Remedesivir/Treated*100, digits = 0), ")", sep = ""),
  ...
  select(Group, Variable, All, Treated, Treated_perc, Paxlovid, Sotrovimab, Remedesivir, Molnupiravir, Casirivimab)
...
flowchart_non_elig_plot$criteria2 = unlist(lapply(strwrap(flowchart_non_elig_plot$criteria, width=30, simplify=FALSE), paste, 
                                                  collapse="\n"))
