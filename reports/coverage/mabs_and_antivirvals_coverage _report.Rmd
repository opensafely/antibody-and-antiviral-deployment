...
# Input directory ----
#input_dir_os <- here("released_outputs")
input_dir_os <- here("output")
...
# Import data ----
report_stats <- read_csv(fs::path(input_dir_os, "reports", "coverage", "tables", "report_stats.csv"))
table_elig_treat_redacted <- read_csv(fs::path(input_dir_os, "reports", "coverage", "tables", "table_elig_treat_redacted.csv"))
table_demo_clinc_breakdown_redacted <- read_csv(fs::path(input_dir_os, "reports", "coverage", "tables", "table_demo_clinc_breakdown_redacted.csv"))
...
include_graphics(fs::path(input_dir_os, "reports", "coverage", "figures", "cum_eligiblity_plot.png"))
...
include_graphics(fs::path(input_dir_os, "reports", "coverage", "figures", "cum_treatment_plot.png"))
```
