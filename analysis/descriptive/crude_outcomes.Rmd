...
# Hospitalisation
outcomes_by_hrc_kable_hospital <- outcomes_all_by_hrc_redacted %>%
  left_join(outcomes_non_treated_by_hrc_redacted, by = "variable") %>%
  left_join(outcomes_treated_by_hrc_redacted, by = "variable") %>%
...
# Critical care
outcomes_by_hrc_kable_critical_care <- outcomes_all_by_hrc_redacted %>%
  left_join(outcomes_non_treated_by_hrc_redacted, by = "variable") %>%
  left_join(outcomes_treated_by_hrc_redacted, by = "variable") %>%
...
# Covid death
outcomes_by_hrc_kable_covid_death <- outcomes_all_by_hrc_redacted %>%
  left_join(outcomes_non_treated_by_hrc_redacted, by = "variable") %>%
  left_join(outcomes_treated_by_hrc_redacted, by = "variable") %>%
...
# Any death
outcomes_by_hrc_kable_any_death <- outcomes_all_by_hrc_redacted %>%
  left_join(outcomes_non_treated_by_hrc_redacted, by = "variable") %>%
  left_join(outcomes_treated_by_hrc_redacted, by = "variable") %>%
...
sgtf_outcomes <- data_processed_clean %>%
  ...
  mutate(
    ...
    covid_hospitalisation_critical_care = ifelse(!is.na(covid_hospitalisation_critical_care),
                                                 plyr::round_any(covid_hospitalisation_critical_care, 5), covid_hospitalisation_critical_care),
...
outcomes_by_hrc_kable_hospital
...
outcomes_by_hrc_kable_critical_care
...
outcomes_by_hrc_kable_covid_death
...
outcomes_by_hrc_kable_any_death
